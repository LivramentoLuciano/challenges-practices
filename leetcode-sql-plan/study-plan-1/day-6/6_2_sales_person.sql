...
-- that only salesperson John and Pam have sales to company RED, so we
-- report all the other names in the table salesperson.

-- Solución utilizando CTE (subquery)
-- Runtime: 1078 ms, faster than 81.19%
WITH RedSales AS (
...
-- Runtime: 1135 ms, faster than 71.72% 
-- (aunque no es tan fiable la veracidad de esta medida)
SELECT sp.name
